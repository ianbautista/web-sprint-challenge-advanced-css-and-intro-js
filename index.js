...
/* Task 4: Create a function called get20s() that takes data as an argument and returns an array 
with names of artists who were born the 20th century (1900-2000) */
...
function get20s(data) {
	...
	for (let i = 0; i < data.length; i++) {
		let century20 = data[i].years.substring(0, 2);
		if20sArray.push(century20);
		if (if20sArray[i] == 19) {
			get20sArray.push(data[i].name);
		}
	}
	return get20sArray;
}
 ...
 *     (1) artists array
 *     (2) a number which is the desired index in the array.
 * removeArtist removes an artist from the array at the index and console.logs the length of the
 * remaining dataset.
 *
...
/* Task 6: Create a function called `addArtist` that can accept an array of information and add it 
...
function lotsOfArt(artistsArray) {
	...
	for (let i = 0; i < artistsArray.length; i++) {
		if (artistsArray[i].paintings > 100) {
			lotsOfArtArray.push(artistsArray[i].name);
		}
	}
...
Create a function called `getHTML()` that takes the parameter `data` and uses a for..in loop to 
format and console.log data like the example above. 

The function should console.log 50 chunks of HTML code that match the structure above. 

‼️ You do **NOT** need to get these to display on your page, but you can copy and paste the result 
into your HTML file if you'd like to see what that would look like. */

function getHTML(/* Code here */) {
	/* Code here */
}

/* STRETCH 2: Create a function called `randomize` that takes a data array as an argument and 
